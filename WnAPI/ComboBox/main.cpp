...
------------
/f - Принудительное завершение задачи
------------
/im - Image (Имя исполнняемого файла процесса)
------------
*/
BOOL CALLBACK DlgProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_INITDIALOG:
	{
		HWND hCombo = GetDlgItem(hwnd, IDC_COMBO1);// Функция GetDlgProcItem() Возвращает HWND указанного дочернего окна.
